...
// create a popover on the top left of the screen that just says "AskATT Loaded"
const askattLoaded = document.createElement('p');
askattLoaded.textContent = 'AskATT Loaded';
askattLoaded.style.position = 'fixed';
askattLoaded.style.top = '0';
askattLoaded.style.left = '0';
askattLoaded.style.zIndex = '10000';
askattLoaded.style.fontSize = 'xx-small';
askattLoaded.style.padding = '2px';
askattLoaded.style.margin = '0px';
askattLoaded.style.backgroundColor = '#0057b8';
askattLoaded.style.color = 'white'; 
askattLoaded.style.opacity = '.4';
document.body.appendChild(askattLoaded);
